...
class Email
{
    ...
    public function __construct($smtpDebug, $host, $user, $pass, $smtpSecure, $port, $setFromEmail, $setFromName)
    {
        ...
        $this->mail->CharSet = 'utf-8';                 // Encoding type of the messages
        $this->mail->setLanguage('br');         // Language of error messages
        $this->mail->isHTML(true);                // Allow to send messages with HTML format
